  ...
  return (
    ...
    >
      ...
      <div className="p-6 text-shadow flex flex-col justify-start w-full mt-[500px]">
        ...
        <p className=" max-h-[100px] z-20 overflow-auto text-sm text-gray-400">{selected.overview}</p>
          ...
          {cast &&
            cast.map((actor) => (
              <div className="flex flex-col ml-6 justify-center items-center">
                ...
                <p className="text-xs font-light text-center w-24 md:w-24">{actor.character}</p>
              </div>
            ))}
        </div>
      </div>
