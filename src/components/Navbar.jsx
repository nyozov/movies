...
export default function Home() {
    ...
    return (
        <>
            {
                <div onClick={() => setMenu(!menu)} className="fixed z-10 flex items-center justify-center rounded-r-md bg-gray-800 hover:bg-gray-700 text-gray-300 ml-0 cursor-pointer inset-0 mt-10 m-auto w-8 h-8">
