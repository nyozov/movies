...
<div className="py-12 px-4 w-1/2">
  ...
  className="lg:max-w-[300px] rounded absolute right-0 top-7 w-1/3 mx-auto bg-gray-800 mt-8 px-6 py-6">
    ...
    <div className='grid grid-cols-2 gap-2'>
      {genres.map((genre) => (
        <div className='bg-red-600 shadow-lg font-semibold px-2 p-1 hover:bg-red-700 flex items-center justify-start cursor-pointer rounded-full text-white'>{genre.name}</div>
      ))}
